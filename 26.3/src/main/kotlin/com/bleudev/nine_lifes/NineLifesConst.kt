...
const val WSTAND_KICK_EVENT_RADIUS = 10
const val WSTAND_KILL_EVENT_RADIUS = 25

const val WSTAND_POST_KILL_TICKS = 5
const val WSTAND_POST_KILL_BLACK_TICKS = 1
...
const val PLAYER_AMETHYSM_RADIUS = 5
const val PLAYER_CHARGED_RADIUS = 5
