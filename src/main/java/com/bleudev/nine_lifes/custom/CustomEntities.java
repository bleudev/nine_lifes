...
public class CustomEntities {
    ...
    public static final EntityType<BlueEyesEntity> BLUE_EYES_TYPE = registerEntity(
        "blue_eyes", EntityType.Builder.create(BlueEyesEntity::new, SpawnGroup.MISC).makeFireImmune().dimensions(0.6f, 1.8f)
    );

    public static void initialize() {
        FabricDefaultAttributeRegistry.register(WANDERING_ARMOR_STAND_TYPE, WanderingArmorStandEntity.createLivingAttributes());
        FabricDefaultAttributeRegistry.register(BLUE_EYES_TYPE, BlueEyesEntity.createLivingAttributes());
    }
}
