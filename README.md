...
[![Latest version](https://img.shields.io/badge/Latest_version-6.4-orange)](https://modrinth.com/mod/nine_lifes/versions)
[![Supported Minecraft versions](https://img.shields.io/badge/Supported_Minecraft_Versions-26.1.2--26.3--snapshot--9-green)](https://modrinth.com/mod/nine_lifes)
...
|-------------------|------------------------|:--------------------------|:------------|:----------------------------|---------------|
| 26.3-snapshot-9   | ✅ 6.4                 | \>= 1.13.12+kotlin.2.4.0  | \>= 0.158.0 | \>= 3.9.6                   | \>= 0.19.2    |
| 26.2              | ✅ 6.4                 | \>= 1.13.12+kotlin.2.4.0  | \>= 0.157.0 | \>= 3.9.6                   | \>= 0.19.2    |
| 26.1.2            | ⚠️ 6.4                 | \>= 1.13.12+kotlin.2.4.0  | \>= 0.155.2 | \>= 3.9.6                   | \>= 0.19.2    |
...
| 1.21.6            | ❌ 2.1 (1.21.6)        | \>= 1.13.8+kotlin.2.3.0   | \>= 0.128.2 | \>= 1.9.2 (midnightlib)     | \>= 0.18.0    |
| 1.21.5            | ❌ 1.5.3 (1.21.5)      | -                         | \>= 0.128.2 | \>= 18.0.145 (cloth config) | \>= 0.17.0    |
