...
| Minecraft version | Max Nine lifes version | Fabric Language Kotlin  | Fabric API  | YACL                    |
|-------------------|------------------------|:------------------------|:------------|:------------------------|
| 26.1              | ❌                      | -                       | -           | -                       |
| 1.21.11           | ✅ 3.0                  | \>= 1.13.8+kotlin.2.3.0 | \>= 0.140.0 | \>= 3.8.2               |
| 1.21.10           | ✅ 3.0                  | \>= 1.13.8+kotlin.2.3.0 | \>= 0.138.3 | \>= 3.8.2               |
| 1.21.9            | ❌ 2.1 (1.21.9)         | \>= 1.13.8+kotlin.2.3.0 | \>= 0.134.0 | \>= 1.9.2 (midnightlib) |
| 1.21.8            | ❌ 2.1 (1.21.6)         | \>= 1.13.8+kotlin.2.3.0 | \>= 0.128.2 | \>= 1.9.2 (midnightlib) |
| 1.21.7            | ❌ 2.1 (1.21.6)         | \>= 1.13.8+kotlin.2.3.0 | \>= 0.128.2 | \>= 1.9.2 (midnightlib) |
| 1.21.6            | ❌ 2.1 (1.21.6)         | \>= 1.13.8+kotlin.2.3.0 | \>= 0.128.2 | \>= 1.9.2 (midnightlib) |
