...
[![Latest version](https://img.shields.io/badge/Latest_version-6.0-orange)](https://modrinth.com/mod/nine_lifes/versions)
[![Supported Minecraft versions](https://img.shields.io/badge/Supported_Minecraft_Versions-26.1.2--26.3--snapshot--3-green)](https://modrinth.com/mod/nine_lifes)
...
|-------------------|------------------------|:--------------------------|:------------|:----------------------------|---------------|
| 26.3-snapshot-3   | ✅ 6.0                  | \>= 1.13.12+kotlin.2.4.0  | \>= 0.155.0 | \>= 3.9.5                   | \>= 0.19.2    |
| 26.2              | ✅ 6.0                  | \>= 1.13.12+kotlin.2.4.0  | \>= 0.155.0 | \>= 3.9.5                   | \>= 0.19.2    |
| 26.1.2            | ✅ 6.0                  | \>= 1.13.12+kotlin.2.4.0  | \>= 0.155.0 | \>= 3.9.5                   | \>= 0.19.2    |
